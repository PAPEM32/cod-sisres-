 ...
 */
public class ConfirmarDividaHistoricaSvc {
	...
	// Construtor
	public ConfirmarDividaHistoricaSvc(String usuario, String senhaCripto) throws SispagException {
	 ...
	 */
	public Divida confirmarDividaHistorica(Divida divida, ConfirmarDividaHistoricaForm myForm, String codUsuario)
...
//		int numeroDocAut = Integer.parseInt(myForm.getNumeroDocAut());
		...
		String[] arrayData2 = myForm.getDataDocEnvio().split("/");
		String dia2 = arrayData2[0];
		String mes2 = arrayData2[1];
		String ano2 = arrayData2[2];
...
//		int numeroDocEnvio = Integer.parseInt(myForm.getNumeroDocEnvio());
		String numeroDocEnvio = myForm.getNumeroDocEnvio();
		String tipoDocEnvio = myForm.getTipoDocEnvio();

		dAODivida.confirmaAtualizaLancamentoHistorica(divida, dataDocAut, numeroDocAut, tipoDocAut, origemDocAut,
				dataDocEnvio, numeroDocEnvio, tipoDocEnvio, codUsuario);
	...
	public List<Divida> getAllDividaHistoricaEmEspera() throws SispagException {
		return dAODivida.getAllDividaHistoricaEmEspera();
	}
}