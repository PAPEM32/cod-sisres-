...
public class confirmarDividaDetalheAction extends org.apache.struts.action.Action {

	public confirmarDividaDetalheAction() {
	}
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			ArrayList<Divida> listDivida = (ArrayList<Divida>) session.getAttribute("listDividaHistorica");
