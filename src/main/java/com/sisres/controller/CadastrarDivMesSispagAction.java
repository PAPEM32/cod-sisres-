...
//Classes do Projeto
import com.sisres.view.CadastrarDivMesSispagForm;

public class CadastrarDivMesSispagAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			CadastrarDivMesSispagForm myForm = (CadastrarDivMesSispagForm) form;
			...
			String codUsuario = (String) request.getSession().getAttribute("usuario");
			...
			try {
				...
				dividaItem = sispagSvc.confirmaDivMes(SISTEMA_ORIGEM_SISPAG, perfil,
						(String) session.getAttribute("matFin"), myForm.getMes(), myForm.getAno(), myForm.getNome(),
						myForm.getCpf(), myForm.getPosto(), myForm.getSituacao(), myForm.getOcCodigo(),
						myForm.getOcNome(), myForm.getBanco(), myForm.getAgencia(), myForm.getContaCorrente(),
						myForm.getValorDivida(), myForm.getOrigemDocAut(), myForm.getTipoDocAut(),
						myForm.getNumeroDocAut(), myForm.getDataDocAut(), myForm.getDataMotivo(), myForm.getMotivo(),
						myForm.getObservacao(), codUsuario);
