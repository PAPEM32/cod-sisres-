...
public class CriaTelaRelatorioDividasOcDTInclusaoAction extends org.apache.struts.action.Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			if (role.equals("OC") || role.equals("SIPM")) {
				...
				listadeoc.add(oc);
			} else if (request.getSession().getAttribute("role").equals("PAPEM-23")
					|| request.getSession().getAttribute("role").equals("ADMINISTRADOR")) {
