...
public class RelatorioDividasOcAction extends org.apache.struts.action.Action {
	...
	public RelatorioDividasOcAction() {
	}

	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		// System.out.println("entrei no action relatorio glaucia2");
		...
		try {
			...
			if (listadeDivida != null) {
				...
				// filename=RelatorioDividasPorOC.pdf");
				response.setHeader("Content-Disposition", "attachment; filename=RelatorioDividasPorOC.pdf");

				// context.log("Tamanho do array: " + listadeDivida.length);
				// context.log("Nova função " );
				// Despacha para view
	...
	private void renderizaTela(String[][][][] listDivida, String periodo, String codUsuario, String obs,
		...
		try {
			...
			// context.log("Lista de dívidas: " + listDivida[0][0][0][0]);

			// context.log("testando o erro");
...
//			context.log("Acabou a tarefa");
	...
	private void createBody(String[][][] listDivida, String periodo, ServletContext sc) throws SemanticException {
		...
		TextTitulo.setContent("RELATÓRIO DE DÍVIDAS POR OC - Data da Dívida <br> " + "Período: " + periodo);
