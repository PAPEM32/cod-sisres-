...
<title>SisRes - Cadastrar Dívida do Historica SIAPE</title>
...
<body>
	...
	<div class="titulo">Cadastrar Dívida Histórica SIAPE</div>
...
%>
				<form id="formCadastrar" name="formCadastrar"
					action="cadastrarDividaHistoricaSiapeAction.do" method="post">
...
%>
						...
						<table width="100%" border="0">
							<tr class="formConsulta">
								...
								<td id="input_nome" style="width: 255px;"><input id="nome"
									...
									maxlength="60" type="text" /> <input id="nome" name="nome"
								...
								<td id="input_cpf" title="Campo requerido" style="width: 120px;">
									...
									value="<%=cpf%>" maxlength="11" type="text" /> <input id="cpf"
									name="cpf" value="<%=cpf%>" type="hidden" />
								</td>
								<td style="border: 1px solid #fff">&nbsp;</td>
							</tr>
							<tr class="formConsulta">
								...
								<td id="input_posto" title="Campo requerido"
									...
									type="text" /> <input id="posto" name="posto"
									value="<%=posto%>" type="hidden" /></td>
						...
						<table width="100%" border="0">
							<tr class="formConsulta">
								...
								<td id="input_banco" title="Campo requerido"
									style="width: 105px;"><select name="banco">
										<option selected="selected" value="">Selecione...</option>
										<%
			...
			%>
								...
								<td id="input_agencia" title="Campo requerido"
									...
									value="<%=agencia%>" maxlength="4" type="text" /> <input
									id="agencia" name="agencia" value="<%=agencia%>" type="hidden" />
									<% } %>
								</td>
								...
								<td id="input_cc" title="Campo requerido" style="width: 120px;">
									...
									type="text" /> <input id="cc" name="contaCorrente"
									value="<%=contaCorrente%>" type="hidden" /> <%} %>
								</td>
								<td style="border: 1px solid #fff">&nbsp;</td>
							</tr>
							<tr class="formConsulta">
