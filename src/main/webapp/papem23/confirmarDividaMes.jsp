...
<title>SisRes - Confirmar Dívida / detalhamento da dÃ­vida</title>
...
%>
	...
	<!-- Formulário -->
	<form id="formConfirmaDivMes" name="formConfirmaDivMes"
		action="confirmarDividaMes.do" method="post">

		<div class="clear"></div>

		<div class="titulo">Confirmar Cadastro - Detalhamento da
			D&iacute;vida Mês</div>
		<div id="conteudo" class="corpoTitulo">
			<div id="innerConteudo">
				...
				<div class="barraBts">
					...
					<a
						href="javascript:document.getElementById('formConfirmaDivMes').submit();">Confirmar
						Dívida</a>

					<!--   <a href="javascript:history.go(-1)">Voltar</a>  -->
					<a href="../papem23/confirmarDividaMensalEmEspera.do">Voltar</a>
